...
/**
 * <p>the data is copy from: </ br> Table 10.5 Dunavant quadrature for area
...
public class SymTriangleQuadrature implements Iterable<QuadraturePoint> {
    ...
    public static double[] cartesianCoordinate(double x1, double y1, double x2, double y2, double x3, double y3, int power, int index, double[] results) {
